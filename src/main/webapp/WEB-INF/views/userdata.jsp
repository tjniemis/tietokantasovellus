...
<html>
	...
	<div id="lomake" align="center" class="lomake">
		...
		<table>
                <form:form name="f" action="modifyUser" modelAttribute="user" method="POST">
                    <form:hidden path="id"/>
		...
		<div class="smallbuttons">
			<button class="ilmoitabutton" onclick="document.f.submit();">Tallenna muutokset</button>
                        <button class="ilmoitabutton" onclick="location.href='deleteUser/${user.id}'">Poista</button>
