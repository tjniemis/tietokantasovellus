...
<html>
	...
	<div id="lomake" align="center" class="lomake">
		<table>
		<tr><td><b>Nimi:</b></td><td><input type="text" size="40"/></td></tr>
		<tr><td><b>Sähköposti:</b></td><td><input type="text" size="40"/></td></tr>
		<tr><td><b>Salasana:</b></td><td><input type="password" size="40"/></td></tr>
		<tr><td><b>Salasana uudestaan:</b></td><td><input type="password" size="40"/></td></tr>
		<tr><td colspan="2" align="center">
		<div class="smallbuttons">
			<button class="ilmoitabutton" onclick="location.href='index.html'">Tallenna</button>
		</div>
		</td></tr>
		</table>
	</div>
